## Testing the hypergeometric nbinom/pois weeks likelihood
getwd()
rm(list = ls())
...
## The average on week 4 has already been made
...
readRDS("~/Documents/Imperial/PostDoc/Zambia/covid-mortality-ascertainment/analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[readRDS("~/Documents/Imperial/PostDoc/Zambia/covid-mortality-ascertainment/analysis/data/Code-generated-data/00_03_Prob_Index_Vector.rds"),] %>%
  mutate(1:72)
...
# Test_02x02 <- cma::fit_spline_rt(prob_non_severe_death_treatment = prob_non_severe_death_treatment$X1,
# Test_1x1 <- cma::fit_spline_rt(prob_non_severe_death_treatment = prob_non_severe_death_treatment$X37,
Test_02x1 <- cma::fit_spline_rt(prob_non_severe_death_treatment = prob_non_severe_death_treatment$X33,
                           data = data,
                           ...
                           dur_R = Inf,
                           log_likelihood = calc_loglikelihood_bin_age_weeks_06,
                           # lld = "ll_nb",
                           ...
                           # HypGeoWeights = HypGeo_Weights_Weeks,
                           # k_death = 7
)

Tests_shorter_duration <- readRDS(file = "../Bonus Files/2022-03-02_Testing_lower_duration_x3.rds")


p1 <- plot(Test, particle_fit = T) + theme(legend.position = "none")

Diagnostic_Plot_06b_Age_Date(1, fit_Model_list = Tests_shorter_duration, IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[c(1,37,41),], ll_type = "ll_nb")
Diagnostic_Plot_06(1, fit_Model_list = list(Tests_shorter_duration[[2]]), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[c(37,41),], ll_type = "ll_nb")
Diagnostic_Plot_06b_Age_Date(1, fit_Model_list = list(Tests_shorter_duration[[3]]), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[c(41),], ll_type = "ll_nb")

tail(Tests_shorter_duration$X1$pmcmc_results$chains$chain1$results$log_posterior)
tail(Tests_shorter_duration$X1$pmcmc_results$chains$chain2$results$log_posterior)
tail(Tests_shorter_duration$X1$pmcmc_results$chains$chain3$results$log_posterior)
...
Diagnostic_Plot_06(1, fit_Model_list = list(Test_02x02), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds"), ll_type = "ll_nb")
Diagnostic_Plot_06b_Age_Date(1, fit_Model_list = list(Test_02x02), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds"), ll_type = "ll_nb")
# Diagnostic_Plot_06(1, fit_Model_list = list(Test_1x1), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds"), ll_type = "ll_nb")

Diagnostic_Plot_06(1, fit_Model_list = list(Test_1x1), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[41,], ll_type = "ll_nb")
Diagnostic_Plot_06(1, fit_Model_list = list(Test_02x1), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[37,], ll_type = "ll_nb")

Diagnostic_Plot_06b_Age_Date(1, fit_Model_list = list(Test_1x1), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[41,], ll_type = "ll_nb")
Diagnostic_Plot_06b_Age_Date(1, fit_Model_list = list(Test_02x1), IFRvals = readRDS(file = "analysis/data/Code-generated-data/00_03_IFR_matrix_coefficients.rds")[37,], ll_type = "ll_nb")
...
hg_l <- dhyper(x = 0, m = 0:54, n = 54:0, k = 3)
hg_w <- hg_l/sum(hg_l)
