...
[![Travis-CI Build Status](https://travis-ci.org/mrc-ide/covid-mortality-ascertainment.png?branch=master)](https://travis-ci.org/mrc-ide/covid-mortality-ascertainment) 
...
- all the data files (in csv or rds format, in the `data/` directory)    
